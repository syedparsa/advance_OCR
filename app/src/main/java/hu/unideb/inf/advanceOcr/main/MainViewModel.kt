...
package hu.unideb.inf.advanceOcr.main
...
import hu.unideb.inf.advanceOcr.util.Language
import hu.unideb.inf.advanceOcr.util.ResultOrError
import hu.unideb.inf.advanceOcr.util.SmoothedMutableLiveData
import com.google.mlkit.nl.translate.TranslateLanguage
import com.google.mlkit.nl.translate.Translation
import com.google.mlkit.nl.translate.Translator
import com.google.mlkit.nl.translate.TranslatorOptions
import hu.unideb.inf.advanceOcr.main.MainFragment.Companion.DESIRED_HEIGHT_CROP_PERCENT
import hu.unideb.inf.advanceOcr.main.MainFragment.Companion.DESIRED_WIDTH_CROP_PERCENT
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val sourceText =
        SmoothedMutableLiveData<String>(
            SMOOTHING_DURATION
        )
    ...
    val modelDownloading =
        SmoothedMutableLiveData<Boolean>(
            SMOOTHING_DURATION
        )
